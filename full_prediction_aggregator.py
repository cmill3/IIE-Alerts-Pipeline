...
def aggregate(event, context):
    gainers_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/gainersC/")["Contents"]
    ...
    losers_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/losersP/")["Contents"]
    ...
    ma_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/MA/")["Contents"]
    ...
    maP_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/MAP/")["Contents"]
    ...
    vdC_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/vdiff_gainC/")["Contents"]
    ...
    vdP_keys = s3.list_objects(Bucket=trading_bucket,Prefix="classifier_predictions/vdiff_gainP/")["Contents"]
    ...
    query_key = maP_key.split("classifier_predictions/maP")[1]
